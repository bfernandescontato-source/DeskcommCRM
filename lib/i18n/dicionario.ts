...
export const DICIONARIO: Traducoes = {
  ...
  "Destino não encontrado nesta campanha.": { es: "Destino no encontrado en esta campaña." },
  "Esta campanha já foi encerrada e não aceita mudanças.": { es: "Esta campaña ya fue finalizada y no acepta cambios." },
  "Esta ação não é possível no estado atual da campanha.": { es: "Esta acción no es posible en el estado actual de la campaña." },
  "Ação desconhecida.": { es: "Acción desconocida." },
  "Importe os contatos antes de iniciar.": { es: "Importa los contactos antes de iniciar." },
  "Escreva a mensagem antes de iniciar.": { es: "Escribe el mensaje antes de iniciar." },
  "A mensagem usa {{link_grupo}}: escolha o grupo de destino antes de iniciar.": { es: "El mensaje usa {{link_grupo}}: elige el grupo de destino antes de iniciar." },
  "Escolha ao menos um número para enviar.": { es: "Elige al menos un número para enviar." },
  "Um dos números escolhidos não existe, está arquivado ou não é de WhatsApp.": { es: "Uno de los números elegidos no existe, está archivado o no es de WhatsApp." },
  "A mensagem foi alterada por outra pessoa enquanto você editava. Recarregue para ver a versão atual.": { es: "El mensaje fue modificado por otra persona mientras editabas. Recarga para ver la versión actual." },
  "O destino foi trocado por outra pessoa. Recarregue para ver o destino atual.": { es: "El destino fue cambiado por otra persona. Recarga para ver el destino actual." },
  "Este destino já foi encerrado. Cadastre um novo grupo.": { es: "Este destino ya fue cerrado. Registra un nuevo grupo." },
  "Versões de mensagem não podem ser editadas; crie uma nova versão.": { es: "Las versiones de mensaje no se pueden editar; crea una nueva versión." },
  "Algum dado está fora do formato permitido.": { es: "Algún dato está fuera del formato permitido." },
  "Este registro já existe.": { es: "Este registro ya existe." },
  "Há uma variável mal formada. Use o formato {{nome}}.": { es: "Hay una variable mal formada. Usa el formato {{nome}}." },
  "Use o link de convite do WhatsApp (https://chat.whatsapp.com/…).": { es: "Usa el enlace de invitación de WhatsApp (https://chat.whatsapp.com/…)." },
  ...
  // ── Central de Disparos (campanhas de mensagem): telas, frases dos eventos e rótulos de estado.
  // Chave = frase inteira em português; os {marcadores} são preenchidos depois de traduzir.
  "Incluir cada envio, clique e resposta (pode ser muita coisa)": { es: "Incluir cada envío, clic y respuesta (puede ser mucho)" },
  "Nada registrado ainda": { es: "Nada registrado todavía" },
  "Iniciar, pausar, trocar a mensagem ou o grupo: tudo aparece aqui, com quem fez.": { es: "Iniciar, pausar, cambiar el mensaje o el grupo: todo aparece aquí, con quién lo hizo." },
  "Ver mais antigos": { es: "Ver más antiguos" },
  "encerrado à mão": { es: "cerrado a mano" },
  "campanha encerrada": { es: "campaña finalizada" },
  "Um grupo recebe as pessoas por vez. Quando ele encher, o sistema avisa — a troca é sempre feita por você, nunca sozinha. O histórico de cada grupo fica guardado.": { es: "Un grupo recibe a las personas por turnos. Cuando se llene, el sistema avisa — el cambio siempre lo haces tú, nunca se hace solo. El historial de cada grupo queda guardado." },
  "Adicionar grupo": { es: "Agregar grupo" },
  "Nenhum grupo cadastrado": { es: "Ningún grupo registrado" },
  "Cadastre o link de convite do grupo do WhatsApp. É o que a mensagem envia em {{link_grupo}}.": { es: "Registra el enlace de invitación del grupo de WhatsApp. Es lo que el mensaje envía en {{link_grupo}}." },
  "Trocar para este grupo": { es: "Cambiar a este grupo" },
  "Usar este grupo": { es: "Usar este grupo" },
  "{usado} de {capacidade} ({pct}) · {base}": { es: "{usado} de {capacidade} ({pct}) · {base}" },
  "membros medidos": { es: "miembros medidos" },
  "pessoas direcionadas (estimativa: o CRM não vê este grupo)": { es: "personas dirigidas (estimación: el CRM no ve este grupo)" },
  "Receberam o link": { es: "Recibieron el enlace" },
  "Cliques": { es: "Clics" },
  "Entraram": { es: "Entraron" },
  "não medido": { es: "no medido" },
  "Saíram": { es: "Salieron" },
  "Ativo desde {quando}": { es: "Activo desde {quando}" },
  "Ainda não foi ativado": { es: "Aún no fue activado" },
  "encerrado em {quando}": { es: "cerrado el {quando}" },
  "Os próximos envios usam o link do novo grupo. Quem já recebeu a mensagem continua com o link que recebeu; a troca fica registrada no histórico.": { es: "Los próximos envíos usan el enlace del nuevo grupo. Quien ya recibió el mensaje conserva el enlace que recibió; el cambio queda registrado en el historial." },
  "Por que o grupo anterior sai?": { es: "¿Por qué sale el grupo anterior?" },
  "Lotou": { es: "Se llenó" },
  "Encerrei por decisão minha": { es: "Lo cerré por decisión mía" },
  "Confirmar troca": { es: "Confirmar cambio" },
  "Grupo atualizado.": { es: "Grupo actualizado." },
  "Dê um nome ao grupo.": { es: "Ponle un nombre al grupo." },
  "Informe um número inteiro.": { es: "Indica un número entero." },
  "Formato esperado: 1203…@g.us": { es: "Formato esperado: 1203…@g.us" },
  "Adicionar grupo de destino": { es: "Agregar grupo de destino" },
  "O link de convite é o que as pessoas recebem. Você pode cadastrar vários grupos e escolher qual está ativo.": { es: "El enlace de invitación es lo que reciben las personas. Puedes registrar varios grupos y elegir cuál está activo." },
  "Nome do grupo": { es: "Nombre del grupo" },
  "BLACK #04": { es: "BLACK #04" },
  "Link de convite": { es: "Enlace de invitación" },
  "Capacidade (opcional)": { es: "Capacidad (opcional)" },
  "Avisamos quando chegar perto.": { es: "Avisamos cuando esté cerca." },
  "ID do grupo (opcional)": { es: "ID del grupo (opcional)" },
  "Só com ele o CRM mede entradas e saídas.": { es: "Solo con él el CRM mide entradas y salidas." },
  "Usar este grupo agora (troca o atual)": { es: "Usar este grupo ahora (reemplaza al actual)" },
  "Usar este grupo agora": { es: "Usar este grupo ahora" },
  "Motivo da troca": { es: "Motivo del cambio" },
  "O grupo anterior lotou": { es: "El grupo anterior se llenó" },
  "Encerrei o anterior por decisão minha": { es: "Cerré el anterior por decisión mía" },
  "Grupo cadastrado.": { es: "Grupo registrado." },
  "Buscar por nome ou telefone": { es: "Buscar por nombre o teléfono" },
  "Número": { es: "Número" },
  "Versão da mensagem": { es: "Versión del mensaje" },
  "Todas as versões": { es: "Todas las versiones" },
  "Grupo de destino": { es: "Grupo de destino" },
  "Todos os grupos": { es: "Todos los grupos" },
  "Filtros rápidos": { es: "Filtros rápidos" },
  "Ninguém corresponde a este filtro": { es: "Nadie coincide con este filtro" },
  "A fila está vazia": { es: "La cola está vacía" },
  "Tente limpar a busca ou escolher outro filtro.": { es: "Prueba limpiar la búsqueda o elegir otro filtro." },
  "Importe os contatos para começar.": { es: "Importa los contactos para empezar." },
  "Estado": { es: "Estado" },
  "Envio": { es: "Envío" },
  "Grupo": { es: "Grupo" },
  "Enviado": { es: "Enviado" },
  "{n} de {total} contatos": { es: "{n} de {total} contactos" },
  "(com filtro, mostrando os que correspondem)": { es: "(con filtro, mostrando los que coinciden)" },
  "Cada alteração cria uma nova versão. Quem já recebeu continua com a versão que recebeu; só os próximos contatos da fila recebem a nova.": { es: "Cada cambio crea una nueva versión. Quien ya recibió conserva la versión que recibió; solo los próximos contactos de la cola reciben la nueva." },
  "Editar mensagem": { es: "Editar mensaje" },
  "Escrever mensagem": { es: "Escribir mensaje" },
  "Nenhuma mensagem ainda": { es: "Ningún mensaje todavía" },
  "Escreva a mensagem para poder iniciar a campanha. Use {{nome}} e {{link_grupo}} para personalizar.": { es: "Escribe el mensaje para poder iniciar la campaña. Usa {{nome}} y {{link_grupo}} para personalizar." },
  "{enviados} enviados · {cliques} cliques ({ctr}) · {respostas} respostas · {falhas} falhas": { es: "{enviados} enviados · {cliques} clics ({ctr}) · {respostas} respuestas · {falhas} fallos" },
  "Versão V{n} aplicada aos próximos contatos.": { es: "Versión V{n} aplicada a los próximos contactos." },
  "Versão V{n} guardada, sem aplicar.": { es: "Versión V{n} guardada, sin aplicar." },
  "Personalize com as variáveis abaixo. O link do grupo nunca fica fixo no texto: trocar o grupo não exige editar a mensagem.": { es: "Personaliza con las variables de abajo. El enlace del grupo nunca queda fijo en el texto: cambiar de grupo no exige editar el mensaje." },
  "Aplicar esta nova versão aos próximos contatos da fila?": { es: "¿Aplicar esta nueva versión a los próximos contactos de la cola?" },
  "Quem já recebeu continua com a versão anterior. Só os contatos que ainda não receberam passam a receber a nova.": { es: "Quien ya recibió conserva la versión anterior. Solo los contactos que aún no recibieron pasan a recibir la nueva." },
  "Só guardar, sem aplicar": { es: "Solo guardar, sin aplicar" },
  "Aplicar aos próximos": { es: "Aplicar a los próximos" },
  "Pendentes": { es: "Pendientes" },
  "Agora": { es: "Ahora" },
  "O que está acontecendo neste instante.": { es: "Lo que está pasando en este instante." },
  "Do contato importado até quem continua no grupo.": { es: "Desde el contacto importado hasta quien sigue en el grupo." },
  "Entradas e saídas do grupo só são contadas quando o grupo de destino é monitorado (informe o ID do grupo em Destinos). Um clique não prova que a pessoa entrou.": { es: "Las entradas y salidas del grupo solo se cuentan cuando el grupo de destino está monitoreado (indica el ID del grupo en Destinos). Un clic no prueba que la persona entró." },
  "Por versão da mensagem": { es: "Por versión del mensaje" },
  "Números de cada texto enviado — sem ranking.": { es: "Números de cada texto enviado — sin ranking." },
  "Respostas": { es: "Respuestas" },
  "Nenhuma versão enviada ainda.": { es: "Ninguna versión enviada todavía." },
  "Por grupo de destino": { es: "Por grupo de destino" },
  "Para onde cada grupo foi direcionando as pessoas.": { es: "A dónde fue dirigiendo cada grupo a las personas." },
  "Recebeu": { es: "Recibió" },
  "Entradas": { es: "Entradas" },
  "Ocupação": { es: "Ocupación" },
  "encerrado": { es: "cerrado" },
  "{joined} / {left} saíram": { es: "{joined} / {left} salieron" },
  "{usado} de {capacidade}": { es: "{usado} de {capacidade}" },
  "(estim.)": { es: "(estim.)" },
  "Nenhum grupo cadastrado.": { es: "Ningún grupo registrado." },
  "Números": { es: "Números" },
  "Cada número envia uma mensagem por vez, no intervalo definido.": { es: "Cada número envía un mensaje por vez, en el intervalo definido." },
  "Intervalo: {n}s entre envios de cada número · limite diário da campanha: {limite}": { es: "Intervalo: {n}s entre envíos de cada número · límite diario de la campaña: {limite}" },
  "o do próprio número": { es: "el del propio número" },
  "{n} por número": { es: "{n} por número" },
  "Último envio": { es: "Último envío" },
  "Pode enviar": { es: "Puede enviar" },
  "Aguardando: {motivo}": { es: "Esperando: {motivo}" },
  "(até {hora})": { es: "(hasta las {hora})" },
  "Nenhum número escolhido para esta campanha.": { es: "Ningún número elegido para esta campaña." },
  "Nenhum envio ainda": { es: "Ningún envío todavía" },
  "Enviando agora": { es: "Enviando ahora" },
  "Restam na fila": { es: "Quedan en la cola" },
  "Grupo atual": { es: "Grupo actual" },
  "Próximo envio": { es: "Próximo envío" },
  "Campanha não está enviando": { es: "La campaña no está enviando" },
  "Destino": { es: "Destino" },
  "Nova campanha": { es: "Nueva campaña" },
  "Esta campanha já foi iniciada e não é mais editada por aqui.": { es: "Esta campaña ya fue iniciada y ya no se edita desde aquí." },
  "Abrir a campanha": { es: "Abrir la campaña" },
  "Passos": { es: "Pasos" },
  "Disparos": { es: "Envíos masivos" },
  "Destinos": { es: "Destinos" },
  "{motivo}. A fila continua exatamente de onde parou.": { es: "{motivo}. La cola continúa exactamente desde donde se detuvo." },
  "Continuar configuração": { es: "Continuar la configuración" },
  "{n} de {total} enviados · {pct}": { es: "{n} de {total} enviados · {pct}" },
  "Trocar grupo": { es: "Cambiar grupo" },
  "Ver campanha": { es: "Ver campaña" },
  "Números da campanha": { es: "Números de la campaña" },
  "Escolha por quais números as mensagens saem. Cada número envia uma por vez, respeitando o intervalo e o limite diário.": { es: "Elige por qué números salen los mensajes. Cada número envía uno por vez, respetando el intervalo y el límite diario." },
  "Carregando números…": { es: "Cargando números…" },
  "Não foi possível listar os números.": { es: "No fue posible listar los números." },
  "Nenhum número conectado. Conecte um em Conexões.": { es: "Ningún número conectado. Conecta uno en Conexiones." },
  "Números atualizados.": { es: "Números actualizados." },
  "Salvar números": { es: "Guardar números" },
  "Ritmo de envio": { es: "Ritmo de envío" },
  "Cada número envia uma mensagem por vez, sempre com o mesmo intervalo entre uma e outra. Vale já para os próximos envios.": { es: "Cada número envía un mensaje por vez, siempre con el mismo intervalo entre uno y otro. Vale ya para los próximos envíos." },
  "Intervalo entre envios de cada número (segundos)": { es: "Intervalo entre envíos de cada número (segundos)" },
  "Entre 10 e 3600. Com 180, cada número envia 20 mensagens por hora.": { es: "Entre 10 y 3600. Con 180, cada número envía 20 mensajes por hora." },
  "Limite diário desta campanha por número (opcional)": { es: "Límite diario de esta campaña por número (opcional)" },
  "Em branco = só vale o limite do próprio número": { es: "En blanco = solo vale el límite del propio número" },
  "Nunca passa do limite diário do próprio número, que continua valendo.": { es: "Nunca supera el límite diario del propio número, que sigue vigente." },
  "Ritmo atualizado.": { es: "Ritmo actualizado." },
  "Salvar ritmo": { es: "Guardar ritmo" },
  "Escreva a mensagem.": { es: "Escribe el mensaje." },
  "Variáveis": { es: "Variables" },
  "e as colunas do seu CSV, como {{cidade}}": { es: "y las columnas de tu CSV, como {{cidade}}" },
  "Como a pessoa vai ver": { es: "Cómo lo verá la persona" },
  "A mensagem usa {{link_grupo}}: cadastre um grupo em Destinos antes de iniciar.": { es: "El mensaje usa {{link_grupo}}: registra un grupo en Destinos antes de iniciar." },
  "Vem do CSV: {colunas}. Contato sem esse dado não recebe (fica como falha, visível na Fila).": { es: "Viene del CSV: {colunas}. El contacto sin ese dato no recibe (queda como fallo, visible en la Cola)." },
  "{n} pausadas": { es: "{n} pausadas" },
  "{n} pausada": { es: "{n} pausada" },
  "Enviados hoje": { es: "Enviados hoy" },
  "nas campanhas ativas": { es: "en las campañas activas" },
  "no link do grupo": { es: "en el enlace del grupo" },
  "Entradas nos grupos": { es: "Entradas a los grupos" },
  "só grupos monitorados": { es: "solo grupos monitoreados" },
  "precisam de atenção": { es: "requieren atención" },
  "Campanhas ativas": { es: "Campañas activas" },
  "Nenhuma campanha em andamento": { es: "Ninguna campaña en curso" },
  "Crie a primeira: importe os contatos, escreva a mensagem, escolha o grupo e os números.": { es: "Crea la primera: importa los contactos, escribe el mensaje, elige el grupo y los números." },
  "As campanhas iniciadas aparecem aqui, com o placar ao vivo.": { es: "Las campañas iniciadas aparecen aquí, con el marcador en vivo." },
  "Outras campanhas": { es: "Otras campañas" },
  "Criada em": { es: "Creada el" },
  "Como se chama esta campanha?": { es: "¿Cómo se llama esta campaña?" },
  "Só para você reconhecer depois. A campanha fica salva como rascunho e você pode voltar a ela quando quiser.": { es: "Solo para que la reconozcas después. La campaña queda guardada como borrador y puedes volver a ella cuando quieras." },
  "Nome da campanha": { es: "Nombre de la campaña" },
  "Black Friday 2026": { es: "Black Friday 2026" },
  "Contatos importados.": { es: "Contactos importados." },
  "{n} contatos já estão nesta campanha.": { es: "{n} contactos ya están en esta campaña." },
  "Você pode importar outro arquivo — quem já está na campanha é ignorado.": { es: "Puedes importar otro archivo — quien ya está en la campaña se ignora." },
  "Arraste o arquivo CSV aqui": { es: "Arrastra el archivo CSV aquí" },
  "Precisa ter uma coluna de telefone. Nome, e-mail e outras colunas (que viram variáveis da mensagem) são opcionais. Aceita arquivos grandes, com dezenas de milhares de linhas.": { es: "Debe tener una columna de teléfono. Nombre, correo y otras columnas (que se vuelven variables del mensaje) son opcionales. Acepta archivos grandes, con decenas de miles de filas." },
  "Enviando o arquivo…": { es: "Enviando el archivo…" },
  "Escolher arquivo": { es: "Elegir archivo" },
  "— não usar —": { es: "— no usar —" },
  "Telefone (obrigatório)": { es: "Teléfono (obligatorio)" },
  "Coluna do telefone": { es: "Columna del teléfono" },
  "Coluna do nome": { es: "Columna del nombre" },
  "Coluna do e-mail": { es: "Columna del correo" },
  "Usar como variável na mensagem": { es: "Usar como variable en el mensaje" },
  "Conferindo as linhas…": { es: "Revisando las filas…" },
  "Conferir arquivo": { es: "Revisar archivo" },
  "Descartar arquivo": { es: "Descartar archivo" },
  "Nada foi importado ainda. Confira os números e confirme.": { es: "Aún no se importó nada. Revisa los números y confirma." },
  "Válidos": { es: "Válidos" },
  "Contatos novos": { es: "Contactos nuevos" },
  "Já existiam no CRM": { es: "Ya existían en el CRM" },
  "Recusados": { es: "Rechazados" },
  "Por que foram recusados": { es: "Por qué fueron rechazados" },
  "Baixar os recusados (CSV)": { es: "Descargar los rechazados (CSV)" },
  "Importando: {feitos} de {total}. Pode atualizar a página — a importação continua de onde parou.": { es: "Importando: {feitos} de {total}. Puedes actualizar la página — la importación continúa desde donde se detuvo." },
  "Continuar importação": { es: "Continuar importación" },
  "Importar {n} contatos": { es: "Importar {n} contactos" },
  "Escreva a mensagem": { es: "Escribe el mensaje" },
  "É o que cada pessoa vai receber. Use as variáveis para personalizar; o link do grupo entra por {{link_grupo}}.": { es: "Es lo que recibirá cada persona. Usa las variables para personalizar; el enlace del grupo entra con {{link_grupo}}." },
  "Mensagem salva.": { es: "Mensaje guardado." },
  "Salvar alteração": { es: "Guardar cambio" },
  "Salvar mensagem": { es: "Guardar mensaje" },
  "Mensagem salva (V{n}).": { es: "Mensaje guardado (V{n})." },
  "Para onde as pessoas vão": { es: "A dónde van las personas" },
  "A mensagem usa {{link_grupo}}: escolha o grupo que recebe as pessoas agora.": { es: "El mensaje usa {{link_grupo}}: elige el grupo que recibe a las personas ahora." },
  "A mensagem não usa {{link_grupo}}, então este passo é opcional.": { es: "El mensaje no usa {{link_grupo}}, así que este paso es opcional." },
  "Usar este": { es: "Usar este" },
  "Link rastreado": { es: "Enlace rastreado" },
  "Com o rastreio ligado, o link enviado passa por este sistema e conta os cliques. Sem ele, vai o link do grupo direto e não há contagem de cliques.": { es: "Con el rastreo activado, el enlace enviado pasa por este sistema y cuenta los clics. Sin él, se envía el enlace del grupo directo y no hay conteo de clics." },
  "Contar cliques no link do grupo": { es: "Contar clics en el enlace del grupo" },
  "Seguir com os outros números": { es: "Seguir con los otros números" },
  "Pausar a campanha inteira": { es: "Pausar toda la campaña" },
  "Por quais números enviar": { es: "Por qué números enviar" },
  "Cada número envia uma mensagem por vez. Mais números, mais rápido.": { es: "Cada número envía un mensaje por vez. Más números, más rápido." },
  "Nenhum número conectado.": { es: "Ningún número conectado." },
  "Conecte um em Conexões": { es: "Conecta uno en Conexiones" },
  "até {n}/dia": { es: "hasta {n}/día" },
  "Ritmo": { es: "Ritmo" },
  "O intervalo é fixo e igual para todos os envios de um número. O sistema não varia o ritmo.": { es: "El intervalo es fijo e igual para todos los envíos de un número. El sistema no varía el ritmo." },
  "Entre 10 e 3600. Com {n}s, cada número envia até {porHora} por hora.": { es: "Entre 10 y 3600. Con {n}s, cada número envía hasta {porHora} por hora." },
  "Em branco = o limite do próprio número": { es: "En blanco = el límite del propio número" },
  "Nunca passa do limite diário do próprio número.": { es: "Nunca supera el límite diario del propio número." },
  "Se um número cair": { es: "Si un número se cae" },
  "Política de número caído": { es: "Política de número caído" },
  "Ritmo salvo.": { es: "Ritmo guardado." },
  "Quanto vai levar": { es: "Cuánto va a tardar" },
  "Escolha ao menos um número para ver a estimativa.": { es: "Elige al menos un número para ver la estimación." },
  "Com {contatos} contatos e até {porDia} mensagens por dia, a fila leva {duracao}.": { es: "Con {contatos} contactos y hasta {porDia} mensajes por día, la cola tarda {duracao}." },
  "É o máximo possível: números em aquecimento, quedas e o horário de envio podem deixar mais lento. Mais números aceleram na mesma proporção.": { es: "Es el máximo posible: números en calentamiento, caídas y el horario de envío pueden hacerlo más lento. Más números aceleran en la misma proporción." },
  "Tudo certo. Ao iniciar, as mensagens começam a sair. Você pode pausar quando quiser e a fila continua do mesmo ponto.": { es: "Todo listo. Al iniciar, los mensajes empiezan a salir. Puedes pausar cuando quieras y la cola continúa desde el mismo punto." },
  "Falta resolver o que está em vermelho antes de iniciar.": { es: "Falta resolver lo que está en rojo antes de iniciar." },
  "Iniciar campanha": { es: "Iniciar campaña" },
  "Campanha pronta. Um administrador precisa iniciá-la.": { es: "Campaña lista. Un administrador debe iniciarla." },
  "Pronta para iniciar": { es: "Lista para iniciar" },
  "Deixar pronta para iniciar": { es: "Dejar lista para iniciar" },
  "Só um administrador inicia o envio.": { es: "Solo un administrador inicia el envío." },
  "Foi enviada": { es: "Fue enviado" },
  "Confirmar que a mensagem foi enviada?": { es: "¿Confirmar que el mensaje fue enviado?" },
  "Use quando você conferiu no WhatsApp do número e a mensagem está lá. O contato passa a Enviado e não recebe outra.": { es: "Úsalo cuando verificaste en el WhatsApp del número y el mensaje está ahí. El contacto pasa a Enviado y no recibe otro." },
  "Tentar enviar de novo?": { es: "¿Intentar enviar de nuevo?" },
  "Use quando você conferiu e a mensagem NÃO está lá. O contato volta para a fila. Se ela tinha saído, a pessoa receberá duas vezes.": { es: "Úsalo cuando verificaste y el mensaje NO está ahí. El contacto vuelve a la cola. Si había salido, la persona lo recibirá dos veces." },
  "Não foi enviada": { es: "No fue enviado" },
  "Marcar como falha?": { es: "¿Marcar como fallo?" },
  "O contato passa a Falhou e não entra mais na fila desta campanha.": { es: "El contacto pasa a Falló y ya no entra en la cola de esta campaña." },
  "Ficha do contato na campanha": { es: "Ficha del contacto en la campaña" },
  "Não dá para saber se esta mensagem saiu.": { es: "No se puede saber si este mensaje salió." },
  "O envio foi interrompido antes da confirmação. Confira no WhatsApp do número {canal} e decida — o sistema nunca reenvia sozinho.": { es: "El envío se interrumpió antes de la confirmación. Verifica en el WhatsApp del número {canal} y decide — el sistema nunca reenvía por sí solo." },
  "Importado de": { es: "Importado de" },
  "Abrir a conversa no Inbox": { es: "Abrir la conversación en la Bandeja" },
  "Dados do CSV": { es: "Datos del CSV" },
  "Importado na campanha": { es: "Importado en la campaña" },
  "Registrado.": { es: "Registrado." },
  "Não foi possível concluir. Tente de novo.": { es: "No fue posible completar. Inténtalo de nuevo." },
  "Central de Disparos": { es: "Central de Envíos" },
  "Campanhas de mensagem pelos seus números: acompanhe o envio, pause quando quiser e veja quem entrou no grupo.": { es: "Campañas de mensajes por tus números: sigue el envío, pausa cuando quieras y ve quién entró al grupo." },
  "Pronta": { es: "Lista" },
  "No grupo": { es: "En el grupo" },
  "Saiu do grupo": { es: "Salió del grupo" },
  "Respondeu": { es: "Respondió" },
  "Clicou": { es: "Hizo clic" },
  "Incerto": { es: "Incierto" },
  ...
  "sem telefone": { es: "sin teléfono" },
  "recusou receber mensagens": { es: "rechazó recibir mensajes" },
  "contato anonimizado": { es: "contacto anonimizado" },
  "contato mesclado": { es: "contacto fusionado" },
  "contato não pode receber": { es: "el contacto no puede recibir" },
  "pausada por você": { es: "pausada por ti" },
  "nenhum número conectado": { es: "ningún número conectado" },
  "um número caiu": { es: "un número se cayó" },
  "sem grupo de destino ativo": { es: "sin grupo de destino activo" },
  "link rastreado": { es: "enlace rastreado" },
  "quando um número cai": { es: "cuando un número se cae" },
  "intervalo entre envios": { es: "intervalo entre envíos" },
  "limite diário por número": { es: "límite diario por número" },
  "Telefone vazio": { es: "Teléfono vacío" },
  "Telefone inválido": { es: "Teléfono inválido" },
  "Repetido no arquivo": { es: "Repetido en el archivo" },
  "Já está nesta campanha": { es: "Ya está en esta campaña" },
  "Linha mal formada": { es: "Fila mal formada" },
  "Clicaram": { es: "Hicieron clic" },
  "Permanecem": { es: "Permanecen" },
  "Taxa de envio": { es: "Tasa de envío" },
  "CTR (clique / enviado)": { es: "CTR (clic / enviado)" },
  "Clique → entrada": { es: "Clic → entrada" },
  "Taxa de saída": { es: "Tasa de salida" },
  "Taxa de permanência": { es: "Tasa de permanencia" },
  "há {n} min": { es: "hace {n} min" },
  "há {n} h": { es: "hace {n} h" },
  "há {n} d": { es: "hace {n} d" },
  "Ao iniciar, as mensagens começam a sair pelos números escolhidos. Um envio não pode ser desfeito. Você pode pausar a qualquer momento, e a fila continua exatamente do ponto em que parou.": { es: "Al iniciar, los mensajes empiezan a salir por los números elegidos. Un envío no se puede deshacer. Puedes pausar en cualquier momento y la cola continúa exactamente desde donde se detuvo." },
  "Encerrar termina a campanha de vez: quem ainda não recebeu deixa de ser contatado e o grupo ativo é fechado. Para só parar um pouco e continuar depois, use Pausar.": { es: "Finalizar termina la campaña de una vez: quien aún no recibió deja de ser contactado y el grupo activo se cierra. Para solo detener un momento y continuar después, usa Pausar." },
  "Descartar campanha": { es: "Descartar campaña" },
  "A campanha não terá envios e não poderá ser retomada.": { es: "La campaña no tendrá envíos y no podrá reanudarse." },
  "Ver números": { es: "Ver números" },
  "Ver incertos": { es: "Ver inciertos" },
  "Ver falhas": { es: "Ver fallos" },
  "Ver importação": { es: "Ver importación" },
  "fora do horário de envio": { es: "fuera del horario de envío" },
  "limite de aquecimento do número": { es: "límite de calentamiento del número" },
  "limite diário do número": { es: "límite diario del número" },
  "aguardando o intervalo entre envios": { es: "esperando el intervalo entre envíos" },
  "limite diário da campanha": { es: "límite diario de la campaña" },
  "Aguardando QR": { es: "Esperando QR" },
  "Responderam": { es: "Respondieron" },
  "Incertos": { es: "Inciertos" },
  "Ignorados": { es: "Ignorados" },
  "{n} contatos na fila": { es: "{n} contactos en la cola" },
  "Importe os contatos": { es: "Importa los contactos" },
  "Mensagem pronta": { es: "Mensaje listo" },
  "A mensagem não usa o link de um grupo": { es: "El mensaje no usa el enlace de un grupo" },
  "Grupo escolhido": { es: "Grupo elegido" },
  "A mensagem usa {{link_grupo}}: escolha o grupo": { es: "El mensaje usa {{link_grupo}}: elige el grupo" },
  "{n} números escolhidos": { es: "{n} números elegidos" },
  "{n} número escolhido": { es: "{n} número elegido" },
  "Escolha ao menos um número": { es: "Elige al menos un número" },
  "não dá para estimar": { es: "no se puede estimar" },
  "menos de 1 dia": { es: "menos de 1 día" },
  "cerca de {n} dias": { es: "alrededor de {n} días" },
  "cerca de {n} semanas": { es: "alrededor de {n} semanas" },
  "cerca de {n} meses": { es: "alrededor de {n} meses" },
  "{quem}criou a campanha": { es: "{quem}creó la campaña" },
  "{quem}deixou a campanha pronta para iniciar": { es: "{quem}dejó la campaña lista para iniciar" },
  "{quem}iniciou a campanha": { es: "{quem}inició la campaña" },
  "{quem}pausou a campanha ({motivo})": { es: "{quem}pausó la campaña ({motivo})" },
  "{quem}pausou a campanha": { es: "{quem}pausó la campaña" },
  "{quem}retomou a campanha": { es: "{quem}reanudó la campaña" },
  "Campanha concluída: todos os contatos foram processados": { es: "Campaña concluida: todos los contactos fueron procesados" },
  "{quem}encerrou a campanha": { es: "{quem}finalizó la campaña" },
  "{quem}cancelou a campanha": { es: "{quem}canceló la campaña" },
  "A campanha parou por um erro": { es: "La campaña se detuvo por un error" },
  "{quem}importou um CSV": { es: "{quem}importó un CSV" },
  "{quem}importou um CSV: {n} contatos, {r} recusados": { es: "{quem}importó un CSV: {n} contactos, {r} rechazados" },
  "{quem}importou um CSV: {n} contatos": { es: "{quem}importó un CSV: {n} contactos" },
  "{quem}alterou {campos}": { es: "{quem}cambió {campos}" },
  "{quem}alterou as configurações": { es: "{quem}cambió la configuración" },
  "{quem}criou a versão V{n} da mensagem": { es: "{quem}creó la versión V{n} del mensaje" },
  "{quem}criou uma nova versão da mensagem": { es: "{quem}creó una nueva versión del mensaje" },
  "{quem}trocou a mensagem ativa": { es: "{quem}cambió el mensaje activo" },
  "{quem}alterou a mensagem V{de} → V{para}": { es: "{quem}cambió el mensaje V{de} → V{para}" },
  "{quem}definiu a mensagem V{para}": { es: "{quem}definió el mensaje V{para}" },
  "{quem}cadastrou o grupo {nome}": { es: "{quem}registró el grupo {nome}" },
  "de destino": { es: "de destino" },
  "{quem}alterou o destino {de} → {para}": { es: "{quem}cambió el destino {de} → {para}" },
  "{quem}definiu o destino {para}": { es: "{quem}definió el destino {para}" },
  "{quem}adicionou {canal} à campanha": { es: "{quem}agregó {canal} a la campaña" },
  "um número": { es: "un número" },
  "{quem}tirou {canal} da campanha": { es: "{quem}quitó {canal} de la campaña" },
  "Mensagem V{n} enviada": { es: "Mensaje V{n} enviado" },
  "por {canal}": { es: "por {canal}" },
  "(confirmado por uma pessoa)": { es: "(confirmado por una persona)" },
  "Falha no envio ({codigo})": { es: "Fallo en el envío ({codigo})" },
  "Falha no envio": { es: "Fallo en el envío" },
  "Envio incerto: não dá para saber se saiu": { es: "Envío incierto: no se puede saber si salió" },
  "Não enviado: {motivo}": { es: "No enviado: {motivo}" },
  "Link clicado": { es: "Enlace pulsado" },
  "Entrou no {destino}": { es: "Entró al {destino}" },
  "Entrou no grupo": { es: "Entró al grupo" },
  "Saiu do {destino}": { es: "Salió del {destino}" },
  "Foi removido do {destino}": { es: "Fue removido del {destino}" },
  "Foi removido do grupo": { es: "Fue removido del grupo" },
  "anterior": { es: "anterior" },
  "guardada": { es: "guardada" },
  "Editar números": { es: "Editar números" },
  "Criar campanha": { es: "Crear campaña" },
  "Campanhas de mensagem pelos seus números: fila, pausa, link rastreado e entrada nos grupos.": { es: "Campañas de mensajes por tus números: cola, pausa, enlace rastreado y entrada a los grupos." },
  "Crie uma campanha de mensagem: importe os contatos, escreva o texto e escolha o grupo e os números.": { es: "Crea una campaña de mensajes: importa los contactos, escribe el texto y elige el grupo y los números." },
  "por {nome}": { es: "por {nome}" },
  "criada em {quando}": { es: "creada el {quando}" },
  "substituída em {quando}": { es: "reemplazada el {quando}" },
